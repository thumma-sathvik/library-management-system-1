          ...
          <div className="group w-full max-w-sm bg-white/95 backdrop-blur-sm rounded-2xl overflow-hidden transition-all duration-300 hover:transform hover:scale-105 hover:shadow-2xl">
            <div className="p-8">
              ...
              <button 
                ...
                className="w-full py-4 bg-gradient-to-r from-gray-700 to-gray-800 text-white rounded-xl text-lg font-medium transition-all duration-300 hover:from-black hover:to-black hover:shadow-lg transform hover:-translate-y-0.5 active:translate-y-0"
              >
                Login as Student
              </button>
            </div>
